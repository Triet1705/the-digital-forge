...
const seedCars = async (prisma) => {
  ...
  //--- TAYCAN ---//
  const taycan = await prisma.car.create({
    data: {
      sku: "CAR-TAYCAN",
      name: "Porsche Taycan",
      showcaseImage:
  ...
  await prisma.version.create({
    data: {
      ...
      technicalDetails: {
        ...
        wheelbase: "2,900 mm",
        width: "1,966 mm",
        imageUrl: "/asset/images/taycan/details/taycan-technical-top-view.svg",
      },
      detailedSpecs: {
        "Power unit": [
          ...
          { label: "Max. torque with Launch Control up to", value: "1,110 Nm" },
        ...
        Performance: [
          ...
          {
            label: "Acceleration (80-120km/h) (50-75 mph) with Launch Control",
            value: "1.4 s",
          },
        ],
        "Consumption/Emissions (WLTP)": [
          ...
          { label: "CO₂-emissions combined (model range)", value: "0 g/km" },
          {
            label: "Electric energy consumption combined (Vehicle High)",
            value: "22.3 kWh/100km",
          },
          {
            label: "Electric energy consumption (City) combined (Vehicle High)",
        ...
        Capacities: [
          ...
          { label: "Luggage compartment volume, rear V210-2", value: "366 l" },
        ],
      },
    },
  });
  ...
  //--- PANAMERA ---//
  const panamera = await prisma.car.create({
    data: {
      sku: "CAR-PANAMERA",
      name: "Porsche Panamera",
      showcaseImage: "/assets/images/panamera/show-case/panamera.webp",
    ...
    data: {
      ...
      detailedSpecs: {
        ...
        Body: [
          ...
          {
            label: "Turning circle (8-speed Porsche Doppelkupplung (PDK))",
            value: "11.9 m",
          },
          {
            label:
  ...
  //--- CAYENNE ---//
  const cayenne = await prisma.car.create({
    data: {
      sku: "CAR-CAYENNE",
    ...
    data: {
      ...
      detailedSpecs: {
        ...
        Body: [
          ...
          {
            label: "Tire track turning circle (8-speed automatic gearbox)",
            value: "11.3 m",
          },
          {
            label:
        ...
        Capacities: [
          { label: "Luggage compartment volume, rear V210-2", value: "698 l" },
          {
            label:
              "Open luggage compartment volume (up to the upper edge of the rear seats)",
            value: "772 l",
  ...
  console.log("Cars and versions seeded.");
};
